...
public final class PlMergeProtos {
  ...
  public  static final class Control extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              ...
              variableSubstitutionMap = input.readMessage(
                  VariableSubstitutionMapDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
              variableSubstitutionMap_.getMutableMap().put(variableSubstitutionMap.getKey(), variableSubstitutionMap.getValue());
              break;
            }
            case 34: {
              com.google.protobuf.ByteString bs = input.readBytes();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
        ...
        com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
        variableSubstitutionMap = VariableSubstitutionMapDefaultEntryHolder.defaultEntry.newBuilderForType()
            .setKey(entry.getKey())
            .setValue(entry.getValue())
            .build();
        output.writeMessage(3, variableSubstitutionMap);
      }
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
        ...
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(3, variableSubstitutionMap);
      }
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
  ...
  bitField0_ |= 0x00000004;
      ...
      public Builder clearVariableSubstitutionMap() {
        getMutableVariableSubstitutionMap().clear();
        return this;
      }
      /**
       * <pre>
      ...
      public Builder removeVariableSubstitutionMap(
          java.lang.String key) {
        if (key == null) { throw new java.lang.NullPointerException(); }
        getMutableVariableSubstitutionMap().remove(key);
        return this;
      }
      /**
      ...
      public Builder putVariableSubstitutionMap(
        ...
        getMutableVariableSubstitutionMap().put(key, value);
        return this;
      }
      /**
       * <pre>
      ...
      public Builder putAllVariableSubstitutionMap(
        ...
        getMutableVariableSubstitutionMap().putAll(values);
        return this;
      }
